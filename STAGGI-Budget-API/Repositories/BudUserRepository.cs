...
{
    public class BudUserRepository : RepositoryBase<BudUser>, IBudUserRepository
    {
        public BudUserRepository(BudgetContext repositoryContext) : base(repositoryContext)
        {
        }
